...
export default defineConfig({
  ...
  use: { baseURL: process.env.PLAYGROUND_URL ?? 'http://127.0.0.1:4173/playground/', headless: true, permissions: ['clipboard-read', 'clipboard-write'], trace: 'retain-on-failure' },
